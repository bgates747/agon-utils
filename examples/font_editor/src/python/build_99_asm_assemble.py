...
def copy_to_emulator():
    try:
        ...
        src_directory = "tgt"
        tgt_directory = ".emulator/sdcard/mystuff/fonts/tgt"
...
def copy_to_sdcard():
    try:
        # Define the source and target directories
        src_directory = "tgt"
        tgt_directory = "/media/smith/AGON/mystuff/fonts/tgt"
...
def generate_font(font_source_file, target_font_directory, app_src_directory, app_tgt_filepath):
    pass
