...
def open_file(app_reference, file_path):
        ...
        app_reference.font_config_editor.set_controls_original_from_config(font_config)
        app_reference.font_config_editor.set_controls_modified_from_config(font_config)
