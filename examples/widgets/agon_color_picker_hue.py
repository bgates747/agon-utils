...
class AgonColorPicker(tk.Toplevel):
    ...
    def __init__(self, parent, **kwargs):
        ...
        self.hues = [0.0, 0.08333333333333333, 0.16666666666666666, 0.3333333333333333, 0.6666666666666666, 0.7638888888888888, 0.8333333333333334]

        self.max_saturation_colors, self.colors_by_hue = mp.process_palette(self.palette, self.hues)
        self.num_hues = len(self.max_saturation_colors) # necessary because not all hues may be present in the palette
    ...
    def on_hue_selected(self, hue):
        ...
        rgb_data = []
        for r, g, b in self.colors_by_hue[hue]:
