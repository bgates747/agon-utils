...
- [ ] **MAIN-05** — [Restart recovery gate](docs/tasks/MAIN-05.md).
  W01 is next: freeze the recovery state/storage contract and independent
  expected outcomes. Recovery precedes the proposed MAIN-04 real MOS cases.

- [ ] **MOS-01** — [Fix missing-OBEY cleanup and prepare an upstream PR](docs/tasks/MOS-01.md).
  Parked by the Author; retain the !boot.obey workaround.
