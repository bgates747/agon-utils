"""W06 raw-image qualification attempt; uses the MOS 3 preferred !boot.obey startup."""
...
def observe(variant):
    ...
    destination = PROFILE / ("w06-boot-obey-" + variant + ".img")
