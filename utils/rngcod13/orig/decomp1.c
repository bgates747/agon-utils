/*
  ...
  decomp1 is an example decompressor able to decompress the files
  produced by comp1.c
...
void usage()
{   fprintf(stderr,"decomp1 [inputfile [outputfile]]\n");
    fprintf(stderr,"decomp1 (c)1999 Michael Schindler, michael@compressconsult.com\n"); 
    exit(1);
}
